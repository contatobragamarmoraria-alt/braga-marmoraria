          ...
          <div className={`px-6 mb-6 md:mb-10 flex items-center ${isCollapsed ? 'justify-center' : 'justify-between'}`}>
            {!isCollapsed && (
              <div className="flex items-center gap-3">
                <img src={user?.avatar || "/logo.png"} alt="Braga Marmoraria" className="w-10 h-10 rounded-full object-cover border border-stone-200 dark:border-white/10 shrink-0" />
            ...
            {isCollapsed && (
               <img src={user?.avatar || "/logo.png"} alt="Braga Marmoraria" className="w-8 h-8 rounded-full object-cover border border-stone-200 dark:border-white/10 shrink-0" />
            )}
      ...
      <main className="flex-1 flex flex-col h-full overflow-hidden relative">
        <header className="flex items-center justify-between p-4 bg-white dark:bg-onyx border-b border-stone-200 dark:border-white/5 shrink-0 z-10">
          ...
          <div className="flex items-center gap-2 md:gap-3">
            <img src={user?.avatar || "https://i.ibb.co/vYm6r8z/logo-braga.png"} alt="Braga Marmoraria" className="w-8 h-8 md:w-10 md:h-10 rounded-full object-cover border border-stone-200 dark:border-white/10 shrink-0" />
